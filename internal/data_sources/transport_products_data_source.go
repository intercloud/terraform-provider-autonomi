	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
			...
			"sort": schema.ListNestedAttribute{
				MarkdownDescription: `List of sort: [location, locationTo, bandwidth, provider, priceNrc, priceMrc]`,
				Optional:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"name": schema.StringAttribute{
							MarkdownDescription: "The name of the key used for sorting. You can set multiple name among **location**, **locationTo**, **bandwidth**, **provider**, **priceNrc**, **priceMrc**",
							Optional:            true,
						},

	...
	resp.Schema = schema.Schema{
		...
		Attributes: map[string]schema.Attribute{
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"name": schema.StringAttribute{
							MarkdownDescription: "Name of the filter among **location**, **bandwidth**, **provider**, **duration**",
							Optional:            true,
						},
			...
			"sort": schema.ListNestedAttribute{
				MarkdownDescription: `List of sort: [location, bandwidth, provider, duration, priceNrc, priceMrc]`,
				Optional:            true,
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						"name": schema.StringAttribute{
							MarkdownDescription: "The name of the key used for sorting. You can set multiple name among **location**, **bandwidth**, **provider**, **duration**, **priceNrc**, **priceMrc**",
							Optional:            true,
						},

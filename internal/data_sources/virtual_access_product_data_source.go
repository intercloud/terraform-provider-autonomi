...
type virtualAccessProductDataSource struct {
...
func NewVirtualAccessProductDataSource() datasource.DataSource {
	return &virtualAccessProductDataSource{}
}

// Metadata returns the data source type name.
func (d *virtualAccessProductDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_virtual_access_product"
}

// Schema defines the schema for the data source.
func (d *virtualAccessProductDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *virtualAccessProductDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *virtualAccessProductDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

...
- `sort` (Attributes List) List of sort: [cspName, cspRegion, cspCity, location, bandwidth, provider, priceNrc, priceMrc, costNrc, costMrc] (see [below for nested schema](#nestedatt--sort))
